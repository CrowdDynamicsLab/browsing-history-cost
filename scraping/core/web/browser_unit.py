...
class BrowserUnit:
    ...
    def __init__(self, browser, log_file, unit_id, treatment_id, headless=False, proxy=None, block_id = None):
...
#               sys.exit(0)
        ...
        if(browser=='firefox'):
            ...
            if (platform.system()=='Darwin'):
                chromedriver = "../core/web/chromedriver/chromedriver_arm64"
            elif (platform.system() == 'Linux'):
